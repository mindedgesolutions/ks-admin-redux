...
const KsApplicationStatus = () => {
  ...
  const allDataApi = `/reports/ks-application-status-all`;
  const breadCrumb = <Link to="/admin/reports">Back to Reports</Link>;
  const resetUrl = `/admin/reports/ks/application-status`;
  ...
  return (
    <>
      <UserPageHeader
        title={`Karmasathi Application Status Report`}
...
export default KsApplicationStatus;
